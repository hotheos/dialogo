...
const I18N = {
  es: {
    lang: 'es',
    htmlLang: 'es',
    title: 'El Foro de las Ideas',
    titleItalic: 'Ideas',
    pageTitle: 'El Foro de las Ideas — Referentes Teológicos y Académicos',
    ...
    footerCredits: 'El Foro de las Ideas © 2026',
  ...
  en: {
    ...
    titleItalic: 'Ideas',
    pageTitle: 'The Forum of Ideas — Theological & Academic References',
    intro: 'Understanding theology requires listening to diverse voices. Here, scholars, apologists, and thinkers from different traditions and viewpoints — Trinitarians, Unitarians, historical critics, conservatives, and skeptics — come together because the honest pursuit of truth is enriched when we engage with those who think differently. Each perspective, backed by years of study and dedication, contributes a piece to the puzzle.',
    ...
    footerCredits: 'The Forum of Ideas © 2026',
  ...
  pt: {
    lang: 'pt',
    htmlLang: 'pt',
    title: 'O Fórum das Ideias',
    titleItalic: 'Ideias',
    pageTitle: 'O Fórum das Ideias — Referências Teológicas e Acadêmicas',
    ...
    footerCredits: 'O Fórum das Ideias © 2026',
